...
class BreakfastSliderWidget extends StatefulWidget {
  const BreakfastSliderWidget();
  @override
  _BreakfastSliderWidgetState createState() => _BreakfastSliderWidgetState();
}

class _BreakfastSliderWidgetState extends State<BreakfastSliderWidget> {
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: imageList.map((url) {
              final int index = imageList.indexOf(url);
              return Container(
                width: 8.0,
                height: 8.0,
                margin:
                ...
                decoration: BoxDecoration(
                    ...
                    color: _current == index ? AppColors.blue : Colors.white),
              );
            }).toList(),
          ),
        ),
